...
class NachOSThread {
  ...
  public:
    ...
    int GetUsage (void);
    // char *page_cache;   //in order to cache the page when replacement takes place
    // void initializePageCache(int size_chache);   //to initialize
...
// while executing kernel code.
  ...
  public:
    ...
    char *backup_memory;    //backup of pages
    void initializeBackupMemory(int size);
#endif
};

...
extern unsigned next_unallocated_page;     //next unallocated page
extern int *LRU_clock;                  //to be used for LRU
...
extern int page_algo;   //page replacement algorithm number
extern TranslationEntry *page_entries[NumPhysPages];   //list of page entries
extern List* page_queue;  //pages that are present in page replacement
...
extern List *freed_pages;            // will store the list of pages freed by syscall exec
extern int reference_bit[NumPhysPages]; // array of reference bits of the page frames
// extern TranslationEntry *page_entries[NumPhysPages];   //maintains a hash-map of page table entries

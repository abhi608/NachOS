...
class TranslationEntry {
  public:
    ...
    bool dirty;         // This bit is set by the hardware every time the
			// page is modified.
    bool shared;        //Whether a particular page is shared or not
    bool cached;        //whether a file is present in cache or not
    int pid_thread;     //the nachos thread to which this page table belongs 
};
